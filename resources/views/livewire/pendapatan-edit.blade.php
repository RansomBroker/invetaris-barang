    ...
    <div class="col-12 col-lg-8">
        <div class="card card-md">
            <div class="card-header d-flex justify-content-between">
                <span>Edit Data Pendapatan</span>
                <div wire:loading>
            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-12 mb-3">
                        ...
                        <input type="text" class="form-control" id="pendapatan" wire:model.defer="pendapatanAmount">
                        @error('pendapatanAmount') <span class="text-danger">{{ $message }}</span> @enderror
                    </div>
                </div>
            </div>
